...
const res_link = 'https://vk.com/hserun';
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://hserun.ru/online-quest/css/404.css" />
    ...
    <body>
        ...
        <div class="parent">
            <div>
                <p class="nftext">КВЕСТ ЗАВЕРШЕН<br>↓<br>
                <button class="back-button" onclick="location.href='<?php echo res_link; ?>';">РЕЗУЛЬТАТЫ</button>
                </p>
            </div>
        </div>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
        <!--script type="text/javascript" src="http://andlogov.ru/hserun/js/nf.js"></script-->
    </body>
</html>