...
<body>
        <div id="notice-turn">
            <div class="notice-turn-inner">
                <div class="notice-turn-text">
                    Для корректной работы сайта рекомендуется портретный режим
                </div>
            </div>
        </div>
        <!-- TEST BUTTON START 
...
<!--script src="//hserun.ru/online-quest/js/marker-window.js"></script-->
</body>
</html>