...
class VK
{
    ...
    public function getAuthorizeUrl($api_settings = '',
                                    $callback_url = 'https://oauth.vk.com/blank.html', $test_mode = false)
    {
        $parameters = array(
     ...
     * @return  array
     */
    public function getAccessToken($code, $callback_url = 'https://oauth.vk.com/blank.html')
    {
    ...
    private function request($url, $method = 'GET', $postfields = array())
    {
        curl_setopt_array($this->ch, array(
            CURLOPT_USERAGENT => 'VK/1.0 (+https://hserun.ru))',
